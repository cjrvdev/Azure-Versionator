...
class AttachmentFileServiceImpl : AttachmentFileService {
    override fun defaultDownloadDirectoryPath(): String {
        ...
        return if (downloadsDirectory.exists() && downloadsDirectory.isDirectory) {
            downloadsDirectory.absolutePath
        } else {
